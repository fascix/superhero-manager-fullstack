...
Après avoir exécuté `npm run seed:users` dans le backend:

- **Admin**: 
  - Username: `admin`
  - Password: `admin123`
  - Accès complet (CRUD + Admin)

- **Éditeur**: 
  - Username: `editor`
  - Password: `editor123`
  - Peut créer et modifier (pas supprimer)
...
npm run seed:users   # Créer utilisateurs de test
```
...
- Exécutez `npm run seed:users` dans le backend
- Vérifiez les identifiants: admin/admin123 ou editor/editor123
